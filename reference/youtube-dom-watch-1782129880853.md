...
- **Captured:** 2026-06-22T12:04:40.840Z
- **URL:** https://www.youtube.com/watch?v=HeBZ_dQQd1I
- **Page type:** Watch
- **Viewport:** 1920×947
...
<ytd-rich-grid-renderer.style-scope.ytd-two-column-browse-results-renderer [elements-per-row="3" is-default-grid]>
  <div#header.style-scope.ytd-rich-grid-renderer [id="header"]>
    <ytd-feed-filter-chip-bar-renderer.style-scope.ytd-rich-grid-renderer [at-start frosted-glass-mode="none" is-dark-theme fluid-width component-style="FEED_FILTER_CHIP_BAR_STYLE_TYPE_DEFAULT" at-end]>
...
<div.ytp-chrome-bottom [data-layer="9"]>
  <div.ytp-progress-bar-container>
    ...
    <div.ytp-progress-bar [tabindex="0" role="slider" aria-label="Seek slider" aria-valuemin="0" aria-valuemax="1614" aria-valuenow="0" aria-valuetext="Intro 0 Minutes 0 Seconds of 26 Minutes 54 Seconds"]>
      <ul#previewbar.sbNotInvidious [id="previewbar"]>
...
```html
<tp-yt-app-drawer#guide.style-scope.ytd-app [id="guide" align="start" role="navigation" position="left" swipe-open]>
  <div#scrim.style-scope.tp-yt-app-drawer [id="scrim"]>
  <div#contentContainer.style-scope.tp-yt-app-drawer [id="contentContainer" position="left" swipe-open]>
...
```html
<ytd-masthead#masthead.masthead-finish [id="masthead" logo-type="YOUTUBE_LOGO" slot="masthead" page-dark-theme frosted-glass-mode="none" role="banner" dark is-watch-page]>
...
```html
<ytd-comments#comments.style-scope.ytd-watch-flexy [id="comments"]>
  <ytd-item-section-renderer#sections.style-scope.ytd-comments [id="sections" initial-count="2" first-lockup-no-top-margin lockup-container-type="3" not-sticky exp-fix-playlist-header enable-related-chips-caching secondary-grid-columns="2" section-identifier="comment-item-section" header-style]>
    <div#header.style-scope.ytd-item-section-renderer [id="header"]>
      <ytd-comments-header-renderer.style-scope.ytd-item-section-renderer [screen-reader-only]>
    ...
    <div#contents.style-scope.ytd-item-section-renderer [id="contents"]>
      <ytd-continuation-item-renderer.style-scope.ytd-item-section-renderer [is-watch-page is-comments-section is-initial-load]>
...
## All Custom Elements On Page (181)
